...
export const ARTICLES: Article[] = [
  ...
  {
    slug: "what-is-indexed-universal-life-insurance",
    question: "What is indexed universal life (IUL) insurance?",
    dek: "Indexed universal life insurance ties your cash value growth to a market index while protecting you from losses, but the details matter a lot before you decide if it fits your situation.",
    updated: "2026-08-04",
    answer: "Indexed universal life (IUL) insurance is a type of permanent life insurance that builds cash value based partly on the performance of a stock market index, such as the S&P 500, while a floor (usually 0%) protects you from direct market losses. Because it is permanent coverage, it stays in force as long as you keep the policy funded, and the death benefit passes to your beneficiaries income-tax-free in most cases. IUL sits between traditional whole life and variable life in terms of growth potential and complexity. It can be a useful tool for the right person, but it is not the right fit for everyone, and I will always tell you that honestly.",
    sections: [
      { h: "How the cash value growth actually works", p: ["When you pay premiums into an IUL, a portion covers the cost of your death benefit and policy fees. The remainder goes into a cash value account. The insurance company then credits interest to that account based on the movement of a chosen index over a set period, usually one year. If the index goes up, you get credited some of that gain, up to a cap rate that the carrier sets and can adjust over time. If the index goes down, your credited rate typically floors at 0%, meaning you do not lose cash value to market drops, but you also do not earn anything that period.", "The catch most people miss is that you are not actually invested in the market. You are earning interest linked to index performance, which sounds similar but is different. Caps often run somewhere in the range of 8 to 12 percent depending on the carrier and the current interest-rate environment, so in a year the index gains 25 percent, your credit is still limited to your cap. On the upside, that 0 percent floor means a bad market year does not erase your savings. Whether that tradeoff makes sense depends entirely on what you are trying to accomplish."] },
      { h: "Flexibility and the fees you need to understand", p: ["One reason people like IUL is its flexibility. Unlike whole life, you can often adjust your premium payments and death benefit within certain limits as your income or needs change. The cash value can be accessed through policy loans or withdrawals, often with favorable tax treatment, which is one reason IUL gets used in retirement-income planning. Policy loans are generally income-tax-free as long as the policy stays in force, though borrowing too much can cause the policy to lapse and create a tax bill.", "The tradeoff for that flexibility is real complexity and layered costs. IUL policies carry mortality and expense charges, administrative fees, and surrender charges if you exit the policy in the early years, which can run ten years or longer. Those fees can meaningfully reduce your actual return, especially in the early years of the policy. I always encourage people to look at an illustration that shows the guaranteed column, not just the projected column, before they decide anything. If an illustration only shows rosy numbers, ask to see what happens if caps drop or credits stay at the floor."] },
      { h: "Who IUL might make sense for, and who it probably does not", p: ["IUL tends to work best for people who already max out their 401(k) and Roth IRA, have a long time horizon of 20 or more years, want permanent death benefit coverage, and are comfortable with some complexity in exchange for potential cash-value growth and tax advantages. Business owners sometimes use it for certain planning strategies, and higher-income earners who have run out of other tax-advantaged savings buckets sometimes find it attractive.", "That said, if your main goal is affordable death benefit protection so your family is covered if something happens to you, term life insurance is almost always cheaper and simpler. If you want guaranteed growth without market linkage, whole life may fit better. IUL is not a good fit if you might need to stop paying premiums within the first several years, if you are not comfortable reading a detailed policy illustration, or if your budget is tight. I will never push someone toward a more complex product when a straightforward one does the job."] },
    ],
    related: [
      { href: "/learn/term-life-vs-whole-life-insurance", label: "Term life vs. whole life: which one do you need?" },
      { href: "/learn/is-a-life-insurance-payout-taxable", label: "Is a life insurance payout taxable?" },
      { href: "/", label: "About Billy Lush: local life insurance" },
    ],
  },
  {
    slug: "what-is-cash-value-life-insurance",
    question: "What is cash value, and can I borrow against my policy?",
    dek: "Cash value is a savings-like feature built into certain permanent life insurance policies, and yes, you can usually borrow against it, but there are real trade-offs worth understanding before you do.",
    updated: "2026-08-11",
    answer: "Cash value is a portion of your premium that builds up inside certain permanent life insurance policies, such as whole life or universal life, over time. Once enough has accumulated, you can often borrow against it or even withdraw from it without going through a bank or credit check. That flexibility is one of the things that makes permanent policies appealing, but borrowing against your policy can reduce or even eliminate your death benefit if you are not careful about repayment. So yes, you can borrow against your policy, and it can be a useful tool, but it is not free money.",
    sections: [
      { h: "How cash value actually builds up", p: ["When you pay a premium on a term life policy, that money covers pure insurance protection and nothing else. Permanent policies work differently. A portion of each premium goes toward the death benefit and the insurer's costs, and another portion goes into what is essentially a separate account that grows over time. Depending on the type of policy, that growth might be at a fixed rate set by the insurer, tied to a market index up to a cap, or linked more directly to investment sub-accounts. The key point is that the cash value belongs to you as the policyholder, and it tends to grow on a tax-deferred basis.", "In the early years of a policy, cash value builds slowly because a bigger share of your premium is going toward insurance costs and surrender charges. Give it time, often ten years or more, and it can become a meaningful asset. I always tell people to look at this as a long game. If you buy a permanent policy and surrender it in year three, you will likely walk away with much less than you put in. Patience is part of the design."] },
      { h: "Borrowing against your policy: how it works and what to watch", p: ["A policy loan is not the same as a withdrawal. When you borrow against your cash value, the insurer uses your cash value as collateral and lends you money, usually at a relatively low interest rate compared to things like credit cards or personal loans. You do not have to qualify, fill out a lengthy application, or explain what you need the money for. The loan does not show up on your credit report. Those are genuine advantages, especially if you are in a pinch or want flexibility without the hassle of a bank.", "The catch is that the loan accrues interest, and if you do not pay it back, that interest compounds and eats into your cash value. If the outstanding loan balance ever grows to equal your cash value, the policy can lapse, which means you lose your coverage and you could owe taxes on the gain. If you die while a loan is outstanding, the death benefit your family receives is reduced by the unpaid balance. I have seen my wife handle enough complicated estates in probate real estate to know that a reduced or lapsed policy can really throw a family's plans off. So borrow if you need to, just go in with a repayment plan."] },
      { h: "Is cash value right for everyone?", p: ["Honestly, no, and I will say that plainly. Cash value makes the most sense when you have a permanent insurance need, meaning you want coverage to be in place no matter when you die, and you are comfortable paying higher premiums than a term policy would cost. If your main goal is to cover your family during your working years as affordably as possible, a straightforward term policy is often the smarter, cheaper choice. Cash value is a feature worth paying for when you actually need what it offers.", "If you are curious about whether a permanent policy with cash value fits your situation, the conversation does not have to be complicated. There is no one-size-fits-all answer, and my job is to help you figure out what makes sense for your family, not to sell you the most expensive product on the shelf. California Lic. 4247326, Texas Lic. 3268220."] },
    ],
    related: [
      { href: "/learn/term-life-vs-whole-life-insurance", label: "Term life vs. whole life: which one do you need?" },
      { href: "/learn/what-is-indexed-universal-life-insurance", label: "What is indexed universal life (IUL) insurance?" },
      { href: "/", label: "About Billy Lush: local life insurance" },
    ],
  },
  {
  ...
  },
  {
    ...
    question: "My spouse died: what should I do first about money, the house, and insurance?",
    dek: "A plain-talk triage list for the weeks after a spouse dies: which pieces need attention now, which can legally move slowly, and what not to touch until you understand the estate.",
    updated: "2026-09-15",
    answer:
      "I am sorry. Now the practical part, because that is usually what people in your position say they need most: very little must happen this week, and knowing that helps. Order several certified death certificates, locate the will and any trust, find any life insurance and file claims right away (those pay fast and outside probate), and keep the mortgage current. Let everything slower, especially probate, move slowly.",
    sections: [
      {
        h: "The first two weeks: triage, not heroics",
        p: [
      ...
      {
        h: "What cannot wait versus what only feels urgent",
        p: [
      ...
      {
        h: "About the house, and about getting help",
        p: [
    ...
    related: [
      { href: "/learn/claim-timeline-vs-probate-timeline", label: "Life insurance claim vs. California probate: two timelines side by side" },
      { href: "/learn/does-life-insurance-go-through-probate", label: "Does life insurance go through probate?" },
      { href: "/learn/how-much-life-insurance-do-i-need", label: "How much life insurance do I actually need?" },
      { href: "/", label: "About Billy Lush: local life insurance" },
    ],
  },
  {
    ...
    dek: "If your named beneficiary dies before you do, the payout could get stuck in probate unless you have a contingent beneficiary on file.",
    updated: "2026-09-22",
    answer:
      "If your primary beneficiary dies before you and you have no contingent beneficiary named, the life insurance proceeds will likely fall into your estate and go through probate. That means a court process, potential delays of months or longer, legal fees, and your family getting money later than they need it. The fix is straightforward: name a contingent beneficiary now, and review your beneficiaries any time your life changes.",
    sections: [
      {
        h: "What actually happens when a primary beneficiary predeceases you",
        p: [
      ...
      {
        h: "What a contingent beneficiary is and why it solves the problem",
        p: [
      ...
      {
        h: "A few California and Texas specifics worth knowing",
        p: [
